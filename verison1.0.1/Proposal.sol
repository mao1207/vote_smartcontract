...
contract Proposal{
    ...
    function storeStartTime(uint _startTime) public {
    ...
    function storeEndTime(uint _endTime) public {
        endTime = _endTime;
    }
    ...
    function storeVoteCount(uint _voteCount) public {
